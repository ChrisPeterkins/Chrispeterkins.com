    ...
    <section id="writing" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div>
        <ul className="group/list">
          {/* Blog post section temporarily removed
          <li className="mb-12">
            <div className="group relative grid grid-cols-8 gap-4 transition-all sm:items-center sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <img alt="Accessibility icon" loading="lazy" width="200" height="48" className="z-10 col-span-2 rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:col-span-2" src="/images/writing/a11y.png" />
              <div className="z-10 col-span-6">
                ...
                <h3 className="-mt-1">
                  <a className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base" href="#" target="_blank" rel="noreferrer">
                    <span>Future Blog Post Here</span>
                  </a>
                </h3>
              </div>
            </div>
